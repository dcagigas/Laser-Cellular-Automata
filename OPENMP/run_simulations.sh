...
echo "----------------------------" >> time_results400.txt
echo " " >> time_results400.txt
X1=`(time ./laseracv10_omp_optim) 2>&1 | grep real | cut -c5-20`
pid="$!"
wait $pid 
...
echo "----------------------------" >> time_results512.txt
echo " " >> time_results512.txt
X2=`(time ./laseracv10_omp_optim) 2>&1 | grep real | cut -c5-20`
pid="$!"
wait $pid 
...
echo "----------------------------" >> time_results1024.txt
echo " " >> time_results1024.txt
X3=`(time ./laseracv10_omp_optim) 2>&1 | grep real | cut -c5-20`
pid="$!"
wait $pid 
...
echo "----------------------------" >> time_results4096.txt
echo " " >> time_results4096.txt
X5=`(time ./laseracv10_omp_optim) 2>&1 | grep real | cut -c5-20`
pid="$!"
wait $pid 
...
echo "----------------------------" >> time_results8192.txt
echo " " >> time_results8192.txt
X6=`(time ./laseracv10_omp_optim) 2>&1 | grep real | cut -c5-20`
pid="$!"
wait $pid 
